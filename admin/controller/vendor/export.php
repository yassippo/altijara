...
class ControllervendorExport extends Controller { 
	...
	public function export() {
		...
		//////////////////////////// seo_keyword///
		$seo_keyword='';
		$query1 = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE `query` = 'product_id=" . (int)$row['product_id'] . "' and store_id = '" . (int)$store_id . "' and  language_id = '" . (int)$language_id . "' limit 0,1");
		if($query1->row)
		{
